...
#Habilitar el reenvio de IP para usar un host como enrutador
...
class NetworkTopo(Topo):
    def build(self, **_opts):
        # Agrega 4 routers en cuatro diferentes subredes
        ...
        # Agregar vinculos de host-switch(conmutador) en la misma subred relativa
        self.addLink(s1,
                     r1,
                     intfName2='r1-eth1',
        ...
        # Agregar vinculos enrutador-enrutador en nuevas subredes para las conexiones enrutador-enrutador
        self.addLink(r1,
                     r2,
                     intfName1='r1-eth2',
                     intfName2='r2-eth2',
        ...
        # Agregando hosts, especificando la ruta por defecto
...
def run():
    ...
    # Agregar rutas Para llegar a redes que no estan conectadas directamente: "metrica" especifica la prioridad
